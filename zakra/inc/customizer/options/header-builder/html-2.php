...
$options = array(
	'zakra_header_html_2_heading' => array(
		'type'         => 'customind-accordion',
		'title'        => esc_html__( 'HTML 2', 'zakra' ),
		'section'      => 'zakra_header_builder_html_2',
		'sub_controls' => apply_filters(
			'zakra_header_html_2_sub_controls',
			array(
				'zakra_header_html_2'                  => array(
					'default'  => '',
				...
				'zakra_header_html_2_text_color'       => array(
				...
				'zakra_header_html_2_link_color_group' => array(
					'type'         => 'customind-color-group',
					'title'        => esc_html__( 'Links', 'zakra' ),
					'section'      => 'zakra_header_builder_html_2',
					'sub_controls' => apply_filters(
						'zakra_header_html_2_link_color_sub_controls',
						array(
							'zakra_header_html_2_link_color'       => array(
								'default'   => '',
								'type'      => 'customind-color',
							...
							'zakra_header_html_2_link_hover_color' => array(
								'default'   => '',
								'type'      => 'customind-color',
				...
				'zakra_header_html_2_font_size'        => array(
				...
				'zakra_header_html_2_margin'           => array(
					'default'     => array(
						'top'    => '',
						'right'  => '',
						'bottom' => '',
		...
		'collapsible'  => apply_filters( 'zakra_header_html_2_accordion_collapsible', false ),
	),
);
