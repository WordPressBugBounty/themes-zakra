			...
			<div class="inside inside__themes">
				...
				$themes_data = array(
					'zakra'    => array(
						...
						'description'     => __( 'Multipurpose WordPress theme loaded with intuitive features, powerful customization options, and pre-built demos to create professional websites of any kind.', 'zakra' ),
					...
					'colormag' => array(
						...
						'description'     => __( 'Modern and professional WordPress magazine and news portal-styled theme perfect for creating websites for your user-engaging magazines, news channels, etc.', 'zakra' ),
			...
			<div class="inside inside__plugins">
				...
				$plugins_data = array(
					'ur'              => array(
						...
						'description'     => __( 'Ultimate WordPress user registration plugin to streamline the user signup process. Create registration & login forms, manage users, and more.', 'zakra' ),
					...
					'evf'             => array(
						...
						'description'     => __( 'Feature-rich and highly customizable WordPress form builder plugin to create different types of professional forms for your website.', 'zakra' ),
					...
					'masteriyo'       => array(
						...
						'description'     => __( 'Streamline the learning process with an easy-to-use and highly advanced LMS plugin loaded with powerful features to create and sell courses online through your website effortlessly.', 'zakra' ),
					...
					'mzb'             => array(
						...
						'description'     => __( 'Powerful WordPress Gutenberg block plugin with the perfect blocks and editing options to create magazine-themed websites.', 'zakra' ),
					...
					'blockart-blocks' => array(
						...
						'description'     => __( 'Highly customizable WordPress Gutenberg block plugin with pre-made templates and powerful blocks to create websites of any niche in no time. ', 'zakra' ),
