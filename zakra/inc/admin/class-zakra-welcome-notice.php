...
class Zakra_Welcome_Notice {
	...
	public function welcome_notice_import_handler() {
		...
		if ( is_wp_error( $state ) ) {
			...
			$response['redirect'] = zakra_is_zakra_pro_active() && zakra_plugin_version_compare( 'zakra-pro/zakra-pro.php', '3.1.0', '>=' ) ? admin_url( 'admin.php?page=zakra-starter-templates&browse=all' ) : admin_url( 'themes.php?page=zakra-starter-templates&browse=all' );
		}
